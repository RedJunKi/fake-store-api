...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -516524111L;
    ...
    public final com.project.fake_store_api.domain.product.QProduct product;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new com.project.fake_store_api.domain.product.QProduct(forProperty("product")) : null;
    }
